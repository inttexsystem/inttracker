...
- `docs/architecture/CODE_HEALTH_RULES.md` — 20 binding architectural health
  rules (18 modularization + 1 language, §19 + 1 test-double fidelity, §20); no
  new code may violate them.
