...
|---|---|---|---|---|---|---|---|
| Dashboard Cliente | `Dashboard Cliente - standalone.html` | `js/screens/cliente-dashboard.js` | ~~KPIs com semântica diferente; sem "pedidos em destaque"; sem distribuição por etapa; sem "ações rápidas"; layout 2 colunas em vez de pilha de seções; sem CTA no header~~ **✅ RESOLVIDO 2026-06-29 — fase `RAVATEX-TAPETES-CLIENTE-DASHBOARD-MATCH-STANDALONE-GLM`** (valores dinâmicos dos dados reais do cliente; shell/sidebar/topbar globais preservados; itens de sidebar do standalone não portados por pertencerem ao shell global) | ✅ fechado | — | — | `RAVATEX-TAPETES-CLIENTE-DASHBOARD-MATCH-STANDALONE-GLM` |
| Novo Pedido | `Novo Pedido - standalone.html` | `js/screens/cliente-pedido-form.js` | ~~Sem "Dados gerais" (referência do cliente, recebimento); itens inline em vez de tabela+modal; sem totais; fluxo de 1 etapa em vez de checkout em 2 etapas~~ **✅ RESOLVIDO 2026-06-29 — fase `RAVATEX-TAPETES-UI-MATCH-STANDALONE-NOVO-PEDIDO`** (modal "Adicionar item" deferido para fase posterior) | ✅ fechado | — | — | `RAVATEX-TAPETES-UI-MATCH-STANDALONE-NOVO-PEDIDO` |
| Modal Adicionar Item | `Modal Adicionar Item - standalone.html` | `js/screens/cliente-pedido-form.js` | ~~Não existe como modal; sem Cor 1/Cor 2/Largura por item; sem referência visual (upload); sem contador de caracteres~~ **✅ RESOLVIDO 2026-06-29 — fase `RAVATEX-TAPETES-UI-MATCH-STANDALONE-NOVO-PEDIDO-ADD-ITEM-MODAL`** (override de Cor 1/Cor 2 por item deferido para fase futura) | ✅ fechado | — | — | `RAVATEX-TAPETES-UI-MATCH-STANDALONE-NOVO-PEDIDO-ADD-ITEM-MODAL` |
