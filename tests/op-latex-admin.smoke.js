...
test('3. index.html carrega op-latex-admin.js EXATAMENTE UMA VEZ, sem type=module', () => {
  ...
  // ACTION-CONTAINMENT-A1 foi a ultima ordem a alterar op-latex-admin.js
  // (associacao de cockpit nos dois ramos alcancaveis), entao ele carrega o
  // token dela. A assercao continua sendo "carregado UMA vez, sem module".
  const reWithQs = /<script\s+src="js\/screens\/op-latex-admin\.js\?v=20260727-ui-action-containment-a1"\s*><\/script>/g;
