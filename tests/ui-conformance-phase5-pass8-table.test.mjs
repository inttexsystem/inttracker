...
test('10.2 UNCHANGED assets keep their previous tokens', () => {
  ...
  // but later authorized orders did touch it — B1, then D11, and most recently
  // D13, which added the --rv-h-inline rung — so it correctly carries the
  // strictly later token of whichever order changed it last.
  assert.match(INDEX, /css\/tokens\.css\?v=20260804-tecelagem-density-inline-rung/);
