...
- **Última fase aceita:** `G28-B5-D5-B4 — RECORD LEGACY DECISION RPC RUNTIME REMOVAL CLOSEOUT` — `CLOSED / ACCEPTED`; commit técnico `3d64b62f25516ef0d18e2613fc50298e2faee16a` — `G28-B5-D5-B4: remove legacy document decision RPC runtime`
